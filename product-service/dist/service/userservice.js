...
class UserService {
    ...
    async createUser(data) {
        ...
        const sanitizedAddress = Sanitizer_1.default.sanitizeAddress(address);
        const sanitizedUsername = Sanitizer_1.default.sanitizeUsername(username);
        const sanitizedPhoneNumber = Sanitizer_1.default.sanitizePhoneNumber(phoneNumber);
    ...
    async updateuser(data, userId) {
        const updatedData = {};
        if (data.username) {
            updatedData.username = Sanitizer_1.default.sanitizeUsername(data.username);
        }
        if (data.phoneNumber) {
