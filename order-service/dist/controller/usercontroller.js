    ...
    constructor(userService) {
        this.createUser = async (req, res, next) => {
            try {
                ...
                const user = await this.userService.createUser({ username, email, phoneNumber, address, password });
                if (user) {
        ...
        this.updateuser = async (req, res, next) => {
            try {
                ...
                const updatedUser = await this.userService.updateuser(profileData, userId);
                if (updatedUser) {
